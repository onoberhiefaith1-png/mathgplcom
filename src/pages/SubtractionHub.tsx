...
const SubtractionHub = () => (
  <main className="relative min-h-screen overflow-hidden bg-background text-foreground animate-fade-in">
    ...
    <header className="relative z-10 flex items-start justify-between p-5 sm:p-8">
      <div>
        <p className="text-xs uppercase tracking-[0.45em] text-amber-400 sm:text-sm">Numbers and Numerals · Subtraction</p>
        <h1 className="mt-2 text-3xl font-semibold sm:text-5xl">Subtraction Borrow Challenge</h1>
        <p className="mt-1 text-sm text-muted-foreground">Master borrowing column-by-column.</p>
      </div>
