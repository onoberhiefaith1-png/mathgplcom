...
/**
 * Every Skill Builder pathway from every class the student belongs to. A locked
...
const StudentAllSkillBuilderPage = () => {
  ...
  return (
    <StudentLearningPage
      ...
      loading={isLoading}
      empty="No Skill Builder activities yet."
    >
      {rows.length === 0 ? (
        <EmptyNote>No Skill Builder activities yet. They appear here once a teacher adds one to your class.</EmptyNote>
      ) : (
