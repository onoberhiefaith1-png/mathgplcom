...
const FractionsHub = ({ title, subtitle, basePath }: Props) => (
  <main className="relative min-h-screen overflow-hidden bg-background text-foreground animate-fade-in">
    ...
    <header className="relative z-10 flex items-start justify-between p-5 sm:p-8">
      <div>
        <p className="text-xs uppercase tracking-[0.45em] text-amber-400 sm:text-sm">Algebra · Fractions</p>
...
export const FractionsImproperHub = () => (
  <FractionsHub
    title="Improper → Mixed"
    subtitle="Convert improper fractions into mixed numbers before they reach the edge."
    basePath="/games/fractions/improper-to-mixed"
  />
);

export const FractionsMixedHub = () => (
  <FractionsHub
    title="Mixed → Improper"
    subtitle="Convert mixed numbers into improper fractions using w × d + n."
    basePath="/games/fractions/mixed-to-improper"
  />
);
