...
const ClassAdventuresPage = () => {
  ...
  useEffect(() => {
    ...
    const ch = supabase
      ...
      .on("postgres_changes", { event: "*", schema: "public", table: "adventure_bar_questions" }, () => { void refresh(); })
      .on("postgres_changes", { event: "*", schema: "public", table: "class_adventures" }, () => { void refresh(); })
