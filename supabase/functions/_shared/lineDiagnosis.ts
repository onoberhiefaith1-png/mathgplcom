...
export function diagnoseLine(
  ...
  studentAscii: string,
  verdict: Verdict,
  /** Informational only — the chips supplied for this line. Never used to
   *  reject a manually typed symbol; every symbol on the active line counts
   *  as part of the student's expression. */
